...
filial_selecionada = st.sidebar.selectbox('Selecione a filial', cidade_filiais)
...
genero_selecionado = st.sidebar.selectbox('Genero cliente:', ['masculino', 'feminino'])
forma_pagamento = st.sidebar.selectbox('Forma de pagamento:', ['boleto', 'credito', 'pix'])

adicionar_venda = st.sidebar.button('Adicionar Venda', use_container_width=True)
if adicionar_venda:
...
remover_venda = st.sidebar.button('Remover Venda', use_container_width=True)
if remover_venda:
